...
public class HomePage {
	...
	public void build_main_menu_actions(Map<String, String> row) {
		// build series of actions to perform like menu and then category and finally
		// subcategory
	...
	public void verify_order_number_in_orders(String order_number) {
		// method to verify order number from confirmation page is present in my orders
		// section
		...
		js.executeScript("arguments[0].style.border='3px solid red'; arguments[0].style.backgroundColor='yellow';",
				order);
